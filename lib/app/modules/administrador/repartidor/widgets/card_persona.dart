...
class CardPersona extends StatelessWidget {
  const CardPersona({Key? key, required this.persona,required this.editarDatosPersona, required this.eliminarPersona, required this.verDatosPersona}) : super(key: key);
  final PersonaModel persona;
  final void Function() verDatosPersona;
  final void Function() editarDatosPersona;
   final void Function()  eliminarPersona;
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: verDatosPersona,
      child: Card(
